...
public class OrdersAddForm extends JFrame {
	...
	public void initialView() {
		...
		lblNewLabel_1_1.setBounds(28, 103, 134, 52);
		...
		textTotal.setBounds(162, 174, 358, 38);
		...
		btnAdd.setBounds(142, 694, 134, 62);
		...
		btnCancel.setBounds(298, 699, 117, 52);
	...
	private void setEventButton() {
		btnAdd.addActionListener(e -> {
			...
			String country = textTotal.getText().trim();
