...
public class StatisticAddForm extends JFrame {
	...
	private void setEventButton() {
		btnAdd.addActionListener(e -> {
			...
			if (name.isEmpty() || inventory.isEmpty()) {
				...
				brand.setName(name);
				brand.setInventory(Integer.valueOf(inventory));
