...
public class StatisticEditForm extends JFrame {
	...
	private JTextArea textInventory;
	
	/**
	 * Create the frame.
	 */
	public StatisticEditForm(Laptop brand) {
	...
	public void initialView() {
		...
		lblNewLabel_1_2 = new JLabel("Inventory");
		lblNewLabel_1_2.setFont(new Font("Comic Sans MS", Font.BOLD, 25));
		lblNewLabel_1_2.setBounds(26, 237, 134, 52);
		contentPane.add(lblNewLabel_1_2);
		
		textInventory = new JTextArea();
		textInventory.setFont(new Font("Dialog", Font.PLAIN, 25));
		textInventory.setBounds(160, 244, 358, 38);
	...
	private void setData() {
		...
		textInventory.setText(String.valueOf(brand.inventory()));
	}
	...
	private void setEventButton() {
		btnUpdate.addActionListener(e -> {
			...
			String inventory = textInventory.getText().trim();
